                ...
                <div className="row">
                  ...
                  <div className="d-flex pt-4">
                    <Tooltip title={`${students} Enrolled`}>
                      <UserSwitchOutlined className="h5 pointer text-info mx-2" />
                    </Tooltip>
                    ...
                    <Tooltip title="Edit">
                      <EditOutlined
                        ...
                        className="h5 pointer text-warning mx-2"
                      />
                    </Tooltip>

                    {course.lessons && course.lessons.length < 5 ? (
                      <Tooltip title="Min 5 lessons required to publish">
                        <QuestionOutlined className="h5 pointer text-danger mx-2" />
                      </Tooltip>
                    ) : course.published ? (
                      <Tooltip title="Unpublish">
                        <CloseOutlined
                          onClick={(e) => handleUnpublish(e, course._id)}
                          className="h5 pointer text-danger mx-2"
                        />
                      </Tooltip>
                    ) : (
                      <Tooltip title="Publish">
                        <CheckOutlined
                          ...
                          className="h5 pointer text-success mx-2"
                        />
                      </Tooltip>
                    )}
                  </div>
